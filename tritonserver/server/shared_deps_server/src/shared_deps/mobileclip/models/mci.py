...
from shared_deps.mobileclip.modules.common.mobileone import MobileOneBlock
from shared_deps.mobileclip.modules.image.replknet import ReparamLargeKernelConv
