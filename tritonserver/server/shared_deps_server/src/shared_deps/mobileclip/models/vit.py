...
from shared_deps.mobileclip.modules.common.transformer import (
    PositionalEmbedding,
    TransformerEncoder,
    get_normalization_layer,
)
from shared_deps.mobileclip.modules.image.image_projection import SimpleImageProjectionHead
from shared_deps.mobileclip import logger
