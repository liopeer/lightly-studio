...
from shared_deps.mobileclip.clip import CLIP
from shared_deps.mobileclip.modules.common.mobileone import reparameterize_model
...
def get_tokenizer(model_name: str) -> nn.Module:
    from shared_deps.mobileclip.modules.text.tokenizer import ClipTokenizer
    ...
    model_cfg = json.load(open(model_cfg_file, "r"))
    return ClipTokenizer(model_cfg)
