...
LIGHTLY_STUDIO_EMBEDDINGS_MODEL_TYPE: str = env.str(
    "LIGHTLY_STUDIO_EMBEDDINGS_MODEL_TYPE", "TRITON_MOBILE_CLIP"
)
LIGHTLY_STUDIO_TRITON_MOBILECLIP_URL: Optional[str] = env.str(
    "LIGHTLY_STUDIO_TRITON_MOBILECLIP_URL", default=None
)
LIGHTLY_STUDIO_TRITON_MOBILECLIP_VARIANT: str = env.str(
    "LIGHTLY_STUDIO_TRITON_MOBILECLIP_VARIANT", "mobileclip_s0"
)
